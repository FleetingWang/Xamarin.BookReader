 ...
 * @date 2016/12/14.
 */
public class EPubReaderFragment : BaseFragment {

    private static String BUNDLE_POSITION = "position";
    private static String BUNDLE_BOOK = "book";
    private static String BUNDLE_EPUB_FILE_NAME = "filename";
    private static String BUNDLE_IS_SMIL_AVAILABLE = "smilavailable";
    ...
    public int getLayoutResId() {
        return Resource.Layout.fragment_epub_reader;
    }
    ...
    private void initSeekbar() {
        ...
        if (mScrollSeekbar.getProgressDrawable() != null)
            mScrollSeekbar.getProgressDrawable()
                    .setColorFilter(ContextCompat.GetColor(mContext, Resource.Color.colorAccent),
