...
{
    [Register("xamarin.bookreader.views.recyclerviews.swipes.SwipeRefreshLayout")]
    public class SwipeRefreshLayout : FrameLayout
    {
        ...
        class CustomRefreshListener : Java.Lang.Object, IAnimationListener
        {
        ...
        class CustomScaleAnimation : Animation
        {
            ...
            {
                swipeRefreshLayout.setAnimationProgress(interpolatedTime);
            }
        }
        class CustomAlphaAnimation : Animation
        {
            private SwipeRefreshLayout swipeRefreshLayout;
            int startingAlpha;
            int endingAlpha;
            ...
            protected override void ApplyTransformation(float interpolatedTime, Transformation t)
            {
                swipeRefreshLayout.mProgress.SetAlpha((int)(startingAlpha + ((endingAlpha - startingAlpha)
                                * interpolatedTime)));
            }
        }
        class CustomCancelListener : Java.Lang.Object, IAnimationListener
        {
            private SwipeRefreshLayout swipeRefreshLayout;
        ...
        class CustommAnimateToCorrectPosition : Animation
        {
            private SwipeRefreshLayout swipeRefreshLayout;
        ...
        class CustommAnimateToStartPosition : Animation
        {
            private SwipeRefreshLayout swipeRefreshLayout;
        ...
        class CustommScaleDownToStartAnimation : Animation
        {
            private SwipeRefreshLayout swipeRefreshLayout;
        ...
        class CustommScaleDownAnimation : Animation
        {
            private SwipeRefreshLayout swipeRefreshLayout;
