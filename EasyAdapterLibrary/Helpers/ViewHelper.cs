...
{
    public interface AbsListView<VH> where VH : EasyLVHolder
    {
        /**
         * 设置textView文本内容
         *
         ...
         * @return viewHolder
         */
        VH setVisible(int viewId, bool visible);
         ...
         * @return viewHolder
         */
        VH setVisible(int viewId, ViewStates visible);
         ...
         * @return viewHolder
         */
        VH setTag(int viewId, Java.Lang.Object tag);
         ...
         * @return viewHolder
         */
        VH setTag(int viewId, int key, Java.Lang.Object tag);
         ...
         * @return viewHolder
         */
        VH setChecked(int viewId, bool check);
         ...
         * @return viewHolder
         */
        VH setTypeface(Typeface typeface, params int[] viewIds);
         ...
         * @return
         */
        VH setOnClickListener(int viewId, View.IOnClickListener listener);
    }

    public interface RecyclerView<VH> where VH : EasyRVHolder
    {
        /**
         * 设置textView文本内容
         *
